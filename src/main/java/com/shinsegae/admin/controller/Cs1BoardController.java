...
@Controller
@RequestMapping("/cs1/*")
public class Cs1BoardController {
	
	private static final Logger logger = (Logger) LoggerFactory.getLogger(Cs1BoardController.class);
    ...
    public String registPOST(@ModelAttribute CsBoard board) throws Exception {
        ...
        csBoardService.registCs1(board);
    ...
    public ModelAndView listAll() throws Exception {
    	ModelAndView mv = new ModelAndView("/cs1/listAll");
    ...
    public ModelAndView read(@RequestParam("boardIdx") int boardIdx) throws Exception {
    	...
    	ModelAndView mv = new ModelAndView("cs1/read");
    	mv.addObject("boardVO",csBoardService.readCs1(boardIdx));
    	return mv;
    }
    ...
    public String remove(@RequestParam("boardIdx") int boardIdx ,RedirectAttributes rttr) throws Exception {
    	...
    	csBoardService.removeCs1(boardIdx);
    ...
    public String removes(@RequestParam("checkedIdForDel") String checkedIdForDel,RedirectAttributes rttr) throws Exception {
    	  ...
    	  logger.info("regist post...");
    	csBoardService.removesCs1(checkedIdForDel);
    	rttr.addFlashAttribute("msg","SUCCESS");
    ...
    public void listAll(Criteria cri, Model model) throws Exception {
    	...
    	model.addAttribute("list", csBoardService.listCriteriaCs1(cri));
    	PageMaker pageMaker = new PageMaker();
    	pageMaker.setCri(cri);
    	pageMaker.setTotalCount(csBoardService.listCountCriteriaCs1(cri));
    ...
    public ModelAndView listPage(@ModelAttribute("page") SearchCriteria cri) throws Exception {
    	...
    	logger.info("show list page ...");
    	ModelAndView mv = new ModelAndView("/cs1/listAll");
    	mv.addObject("list", csBoardService.listCriteriaCs1(cri));
    	PageMaker pageMaker = new PageMaker();
    	pageMaker.setCri(cri);
    	pageMaker.setTotalCount(csBoardService.listCountCriteriaCs1(cri));
