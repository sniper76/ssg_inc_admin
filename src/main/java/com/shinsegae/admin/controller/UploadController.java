...
import com.shinsegae.admin.common.utils.MediaUtils;
...
//	String uploadPath = "c:/upload";
    ...
    @RequestMapping(value="/upload/ckeditorupload")
    public void imageUpload(HttpServletRequest request, HttpServletResponse response,
        ...
        uploadFile = UploadFileUtils.uploadFile(uploadPath, upload.getOriginalFilename(), upload.getBytes());       
        logger.info(" uploadFile  -   {}", uploadFile);
          
        //3.URL 상에서 볼수 있는 이미지 경로
        // /displayFile?fileName="+ fileName;
        
        fileUrl ="/upload/displayFile?fileName="+ uploadFile.replaceAll("\\\\", "/");
		...
		outData.put("url", fileUrl);
        
        
 
        printWriter.println(outData.toString());
        printWriter.flush();
    }
