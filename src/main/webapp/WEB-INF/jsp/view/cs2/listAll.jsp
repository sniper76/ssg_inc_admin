...
<%@ taglib prefix="fmt" uri="http://java.sun.com/jsp/jstl/fmt" %>
					<form name="frm" action = "<c:url value='/cs2/listPage.do' />" method="post">
											...
											<div class="table">
												...
												<div class="tbody">
													...
													<div class="row">
														...
														<span class="cell w3"><a href="<c:url value='/cs2/read.do?boardIdx=${boardVO.boardIdx}' />">${boardVO.title}</a></span>
										...
										<div class="paging_box al_c">
											<ul class="paging_list flt_clr">
												...
												<c:if test="${pageMaker.prev}">
													<li class="btn_arrow btn_prev"><a href="/cs2/listPage.do${pageMaker.makeSearch(pageMaker.startPage -1)}""><img src="/images/comm/btn_arrow.png" alt="prev" /></a></li>
												</c:if>
												
												<c:forEach begin="${pageMaker.startPage}" end="${pageMaker.endPage }" var="idx">
												<li 
												    <c:out value="${pageMaker.cri.page == idx?'class =active':''}"/>>
													<a href="/cs2/listPage.do${pageMaker.makeSearch(idx)}">${idx}</a>
												</li>
												</c:forEach>
												
												<c:if test="${pageMaker.next && pageMaker.endPage>0}">
													<li class="btn_arrow btn_next"><a href="/cs2/listPage.do${pageMaker.makeSearch(pageMaker.endPage +1)}"><img src="/images/comm/btn_arrow.png" alt="next" /></a></li>
												</c:if>
...
function fnDeleteCs() {
    ...
    if(checkedIds.length > 0) {
        if(confirm("삭제하시겠습니까?")){
            ...
            document.frm.action = "../cs2/removes.do";
