							...
							<li class="mid_in">
								<div class="mid_in_list">
									...
									<div class="box_con">
										<div class="table_wrap">
											<div class="search flt_clr">
												...
												<div class="btn_search flt_l">
													<button type="button" id="searchBtn"><img src="/images/comm/btn_search.png" alt="search" /></button>
												</div>
											</div>
											<div class="table">
												<div class="thead">
												...
												<div class="tbody">
													...
													<div class="row">
														...
														<span class="cell w3"><a href="<c:url value='/notice/read.do?boardIdx=${boardVO.boardIdx}' />">${boardVO.title}</a></span>
														<span class="cell w4"><fmt:formatDate pattern="yyyy-MM-dd" value="${boardVO.createDatetime}" /></span>
														<span class="cell w5">${boardVO.hitCnt}</span>
													</div>
												    </c:forEach>
										...
										<div class="btn_wrap">
											<button type="button" class="btn_comm btn_delete" onclick="javascript:fnDeleteNotice()">삭제</button>
											<button type="button" class="btn_comm btn_upload" onclick="location.href='/notice/addNew.do'">등록</button>
										</div>
										...
										<div class="paging_box al_c">
											<ul class="paging_list flt_clr">
												...
												<c:if test="${pageMaker.prev}">
													<li class="btn_arrow btn_prev"><a href="/notice/listPage.do${pageMaker.makeSearch(pageMaker.startPage -1)}"><img src="/images/comm/btn_arrow.png" alt="prev" /></a></li>
												</c:if>
												
												<c:forEach begin="${pageMaker.startPage}" end="${pageMaker.endPage }" var="idx">
												<li 
												    <c:out value="${pageMaker.cri.page == idx?'class =active':''}"/>>
													<a href="/notice/listPage.do${pageMaker.makeSearch(idx)}">${idx}</a>
												</li>
												</c:forEach>
												
												<c:if test="${pageMaker.next && pageMaker.endPage>0}">
													<li class="btn_arrow btn_next"><a href="/notice/listPage.do${pageMaker.makeSearch(pageMaker.endPage +1)}"><img src="/images/comm/btn_arrow.png" alt="next" /></a></li>
												</c:if>
...
function fnDeleteNotice() {
    ...
    if(checkedIds.length > 0) {
        if(confirm("삭제하시겠습니까?")){
            ...
            document.frm.action = "../notice/removes.do";
